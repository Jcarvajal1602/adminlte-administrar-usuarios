...
<head>
  ...
  <link href="vistas/plugins/datatables-responsive/css/responsive.bootstrap4.css" rel="stylesheet">
  ...
  if (isset($_SESSION['iniciarSesion']) && $_SESSION['iniciarSesion'] == "ok" ) {
    ...
    if (isset($_GET['ruta'])) {
      if ($_GET['ruta'] == "inicio" || $_GET['ruta'] == "usuarios" || 
          $_GET['ruta'] == "productos" || $_GET['ruta'] == "crearventa" ||
          $_GET['ruta'] == "reporteventa" || $_GET['ruta'] == "salir") {
